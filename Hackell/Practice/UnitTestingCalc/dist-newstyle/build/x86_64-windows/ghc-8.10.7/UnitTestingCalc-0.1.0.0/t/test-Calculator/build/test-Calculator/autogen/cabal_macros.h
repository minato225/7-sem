...
/* package UnitTestingCalc-0.1.0.0 */
#ifndef VERSION_UnitTestingCalc
#define VERSION_UnitTestingCalc "0.1.0.0"
#endif /* VERSION_UnitTestingCalc */
#ifndef MIN_VERSION_UnitTestingCalc
#define MIN_VERSION_UnitTestingCalc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_UnitTestingCalc */
...
#define CURRENT_COMPONENT_ID "UnitTestingCalc-0.1.0.0-inplace-test-Calculator"
